...
$(document).ready(function () {
    if ($("#product-detail-description").length)         // use this if you are using id to check
    {
        ...
        var text = "Dobrý den, na našem eshopu jsem našli produkt, který je o $price_different dražší a nabízí $advantage. Chcete se na něj podívat?";
        createChat(text);
...
function createChat(text) {
    $("<a id='menu' class=\"float-button biAEAb\"><svg height=\"24\" viewBox=\"0 0 24 24\" width=\"24\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z\"></path><path d=\"M0 0h24v24H0z\" fill=\"none\"></path></svg></a>" +
        ...
        "                                                                         alt=\"avatar\"></div>" +
        "                <div class=\"chat-ts-bubble sc-bZQynM message\">" + text + "</div>" +
        "            </div>" +
        "            <div class=\"chat-os sc-EHOje edRFCv\">" +
        "                <ul class=\"chat-os-options sc-ifAKCX gkhNlr\">" +
        "                    <li class=\"chat-os-option sc-htpNat message-button\"><a class=\"chat-os-option-element sc-bxivhb fMcZCH\">Ano</a></li>    " +
        "                    <li class=\"chat-os-option sc-htpNat message-button\"><a class=\"chat-os-option-element sc-bxivhb fMcZCH\">Ne</a></li></ul>" +
        "            </div>" +
        "           </div>" +
